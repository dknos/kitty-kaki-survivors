#!/usr/bin/env node
/**
 * Smoke test upgraded Magic Missile.
 * Boots local server, launches Playwright, runs game 18s, screenshots,
 * captures console.error + pageerror. Reports perf snapshot.
 *
 * Run: node tools/smoke-missile.js
 */
...
async function main() {
  ...
  const screenshotPath = path.join(__dirname, 'smoke-missile.png');
