#!/usr/bin/env node
/**
 * Smoke test merge geometry optimization.
 * Boots local server, launches Playwright, runs game 12s, screenshots,
 * captures console.error + pageerror. Reports perf snapshot.
 *
 * Run: node tools/smoke-merge.js
 */
...
async function main() {
  ...
  const screenshotPath = path.join(__dirname, 'smoke-merge.png');
